...
with col1:
    ...
    st.download_button(label="Click Here To Download",
              data=open("labcompanion.apk", "rb").read(),  # Change "labcompanion.apk" to the name of your APK file
...
st.markdown('<p class="footer-text">2026 Batch, NSS College Of Engineering</p>', unsafe_allow_html=True)
